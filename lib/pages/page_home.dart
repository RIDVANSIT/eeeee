import 'package:excercise_of_me/pages/page_exchange.dart';
    ...
    return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
      ...
      Padding(
        ...
        child: GestureDetector(
          ...
          child: const Text(
            'Add Coin',
            style: TextStyle(color: Color(0xff07F8B5), fontSize: 16),
          ),
        ),
      )
    ]);
          ...
          Row(
            ...
            children: [
              Padding(
                padding: EdgeInsets.all(8.0),
                child:
                    Image(image: AssetImage('assets/images/bitcoin_icon.png')),
              ),
              Padding(
                padding: EdgeInsets.all(8.0),
                child: Column(
